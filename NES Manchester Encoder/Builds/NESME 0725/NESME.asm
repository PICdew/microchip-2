...
__CONFIG 0x3FC1;_INTRC_OSC_NOCLKOUT & _WDT_OFF & _PWRTE_ON & _MCLRE_OFF & _CP_OFF & _CPD_OFF
...
;	movwf	OSCCAL						;Поместим в регистр
	...
	movlw	b'00001000'					;GP4 вход, остальные выходы
...
MANCHESTER
mtx_init
	movlw   0x85						;Значение длительности импульсов 
